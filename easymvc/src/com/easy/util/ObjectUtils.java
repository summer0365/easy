...
public abstract class ObjectUtils {
	...
	public static Object[] toObjectArray(Object source) {
		...
		if (!(source.getClass().isArray())) {
			throw new IllegalArgumentException(new StringBuilder().append("Source is not an array: ")
					.append(source)
					.toString());
		}
		...
		Object[] newArray = (Object[]) (Object[]) Array.newInstance(wrapperType,
				length);
	...
	public static String identityToString(Object obj) {
		...
		return new StringBuilder().append(obj.getClass().getName())
				.append("@")
				.append(getIdentityHexString(obj))
				.toString();
	}
